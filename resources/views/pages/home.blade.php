                ...
                <div id="w-node-_9a760fa5-1d7c-47d1-0b28-4e9e8cf6c839-1c8bddfb" class="upcoming-events-card">
                    ...
                    <div class="upcoming-events-text-box-wrap">
                        @forelse ($upcomingEvents ?? [] as $event)
                            <x-event-item-small :event="$event" />
                        @empty
                            <p class="text-regular neutral-color-01">No upcoming events at the moment.</p>
                        @endforelse
                    </div>
                    <a data-wf--link-button--variant="arow-large-white" href="{{ route('insights') }}"
